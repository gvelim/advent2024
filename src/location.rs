...
mod test {
    ...
    fn test_location() {
        ...
        assert_eq!(
            Location(1, 1).move_relative((0, isize::MAX)),
            Some(Location(1, 9223372036854775808_usize))
        );
        assert_eq!(
            Location(1, 1).move_relative((isize::MAX, 0)),
            Some(Location(9223372036854775808_usize, 1))
        );
    }
}
